...
for data_set_name in data_sets:
    ...
    # save data splits
    data_splits["fold_0"]["train"].to_csv(f"{atomic_folder_path}/{data_set_name}.train_split_fold_0.inter",
                                          index=False)
    data_splits["fold_0"]["train"].to_csv(f"{atomic_folder_path}/{data_set_name}.train_split_fold_0.tsv", sep='\t',
                                          header=False, index=False)

    data_splits["fold_0"]["valid"].to_csv(f"{atomic_folder_path}/{data_set_name}.valid_split_fold_0.inter",
                                          index=False)
    data_splits["fold_0"]["valid"].to_csv(f"{atomic_folder_path}/{data_set_name}.valid_split_fold_0.tsv", sep='\t',
                                          header=False, index=False)

    data_splits["fold_0"]["test"].to_csv(f"{atomic_folder_path}/{data_set_name}.test_split_fold_0.inter", index=False)
    data_splits["fold_0"]["test"].to_csv(f"{atomic_folder_path}/{data_set_name}.test_split_fold_0.tsv", sep='\t',
                                         header=False, index=False)
