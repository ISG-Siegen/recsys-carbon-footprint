...
log_file_directory = 'experiment_logs_macStudio_journal/power_logger'
experiment_log_file_directory = 'experiment_logs_macStudio_journal/energy'
        ...
        for recommender in recommenders:
            for stage in stages:
                evaluate_log = json.load(
                    open(Path(
                        f"experiment_logs_macStudio_journal/energy/{data_set_name}_{recommender}_0_{num_fold}_{stage}.json"),
                        "r"))

                performance_log = json.load(
                    open(Path(
                        f"experiment_logs_macStudio_journal/data_sets/{data_set_name}/checkpoint_{recommender}/config_0/fold_{num_fold}/evaluate_log.json"),
                        "r"))
